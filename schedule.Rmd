...
```
###<span style="color: blue;">The schedule is being regularly updated for online transition
</span>
...
The writing project for this unit will be to syntheize information on how to incorporate and make use of others’ texts in academic writing.You can read more about the project on the [Projects](https://smartjw.github.io/collaborative_writing/resources.html) page.

###March 18 & March 20

<span style="color: blue;">
This week we will be observing an extended break in response to the COVID-19 outbreak.  All assigned readings and due dates have been postponed.  
</span>

###March 25

On or before March 25th, please complete the following four tasks: 

* Read Stedman's (2011) [Annoying Ways People Use Sources](http://writingspaces.org/sites/default/files/stedman--annoying-ways.pdf) from the open textbook *[Writing Spaces](http://writingspaces.org/)*.
* Complete the [one-question quiz](https://forms.gle/U1mgMjC4q6DfytPB9) on Stedman's article by Friday. 
* Download and install [Zotero](https://guides.zsr.wfu.edu/zotero/install). 
* Complete the topic interest [survey](https://forms.gle/yJ411nRjoDo3Ht91A) for Project 3.

###March 26

Join the rest of the class for an **optional** open dicussion (via Zoom) at 10am. I'll host these every week. 

###March 27

*Make sure to complete the [quiz](https://forms.gle/U1mgMjC4q6DfytPB9) on Stedman if you haven't already.*

Teaching and outreach librarian [Meghan Webb](https://zsr.wfu.edu/directory/meghan-webb/) has created a Voicethread workshop on how to use Zotero for class collaboration.  You can access the Voicethread here (to comment on the thread, you'll need to be logged in via your WFU account at wfu.voicethread.com):   

https://wfu.voicethread.com/myvoice/thread/13853566/

While you watch, you can consult with Professor Webb regarding using Zotero for citing sources (and other questions) through Voicethread (use the comment function - Professor Web explains how in the Voicethread).  

Wake has a [guide](https://guides.zsr.wfu.edu/zotero/install) for installing Zotero. Also, make sure you have Microsoft Word with Zotero working. You can get Word as part of the MS Office 365 program through WFU's [software download page](https://software.wfu.edu/). Zotero also works in other word processing software (e.g., [Google Docs](https://www.zotero.org/support/google_docs), [Libre Office](https://www.zotero.org/support/libreoffice_writer_plugin_usage)), but Professor Webb's workshop explains how to use Zotero with MS Word.

* [Here's](https://guides.zsr.wfu.edu/zotero/self-guided) a self-guided tour for getting Zotero up and running. 
* [Here's](https://guides.zsr.wfu.edu/zotero/groups) a guide to using Zotero's group libraries for collaboration. 

###April 1-3

For the week of March 30-April 3, we'll be reading and discussing Hyland's (2006) "Disciplinary Differences: Language Variation in Academic Discourses" (available [here](https://smartjw.github.io/collaborative_writing/hyland_2006.pdf)).  This is a long and fairly complex article, so we'll be talking about it all week. I recommend reading it in two parts (part one: through page 17, part two: the remainder). 

Once you've read through the article, add your own thoughts to a class discussion document [here](https://docs.google.com/document/d/1IfMZ3T_HDv1fVBXlawddCevGnj_QR1-BvZUQEHkTs64/edit?usp=sharing).

Join our optional Zoom chat on Thursday (4/2) at 10am if you can.  

###April 8

Please read Haller's (2010) [essay](http://www.writingspaces.org/sites/default/files/haller--walk-talk-cook-eat.pdf) "Walk, talk, cook, eat: A guide to using sources".  This essay is also from [*Writing Spaces*](http://www.writingspaces.org/haller--walk-talk-cook-eat). While you are reading, think about your own practices for incorporating sources in your writing.  How are they similar or different to other types of academic writing you've read (e.g., Hyland, 2006)? 

###April 10
This is a holiday on the WFU academic calendar, so there is no assigned reading.  Please submit your draft of Project 3 to the Shared Drive.  

###April 15-17

No required readings this week.  Continue to work on finding research on your topic and reading the studies (and make sure to add sources to Zotero if you haven't already). 

Read and comment on your group members' drafts

On April 15th and 17th I will host two short workshops (via Zoom) on how to use MiCUSP.  Make sure you attend one of the two workshops.  You'll receive an email with the times and Zoom links.  

#Unit 4: Reflect

###April 22-24

* If you haven't already, make sure to read and comment on the drafts in your writing group.  Email them a summary letter with your comments (cc me too).  

* Our final reading: Please read [Remixing](https://github.com/smartjw/collaborative_writing/blob/master/docs/harris_remixing.pdf) from the Harris' (2017) book *Rewriting: How to do things with texts*. This chapter explores the idea of writing as remixing (and connects back to some of the key ideas from Lessig that we read a few weeks ago).

* For Project 4, you will be writing an original plagiarism (see the [page on writing projects](https://smartjw.github.io/collaborative_writing/resources.html#project_4:_original_plagiarism)).  
