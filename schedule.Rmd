...
Before class, please read (and take notes) on Harris' (2017) chapter [Remixing](https://github.com/smartjw/collaborative_writing/blob/master/docs/harris_remixing.pdf) from the book *Rewriting: How to do things with texts*.
